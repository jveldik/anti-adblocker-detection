...
from tkinter import Frame, PhotoImage, Button, LEFT
...
def get_urls_to_label():
    ...
    with open("data/stored_urls.txt", mode = 'r', newline = '') as file:
        lines = file.readlines()
        return [line.strip() for i, line in enumerate(lines) if i >= nr_labeled_urls and line.strip()]
